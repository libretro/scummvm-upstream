...
void LibretroGraphics::realUpdateScreen(void) {
	...
	if (_mouseVisible && _mouseImage.w && _mouseImage.h)
		_screen.blitFrom(_mouseImage, Common::Point(LIBRETRO_G_SYSTEM->_mouseX - _mouseHotspotX, LIBRETRO_G_SYSTEM->_mouseY - _mouseHotspotY), _mousePaletteEnabled ? &_mousePalette : &_gamePalette);
